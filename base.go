...
var (
	configJson = flag.String("config_json", "./integrations.json", "API credentials")
	...
	adwordsUserListServiceUrl       = ServiceUrl{"https://adwords.google.com/api/adwords/rm/v201609", "AdwordsUserListService"}
